...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/huichuan`
...
services:
  huichuan:
    image: calciumion/huichuan:latest
    container_name: huichuan
    restart: always
    ports:
      - "3000:3000"
    volumes:
...
```bash
# 拉取最新镜像
docker pull calciumion/huichuan:latest
