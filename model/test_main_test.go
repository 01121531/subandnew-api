...
func truncateTables(t *testing.T) {
	...
	t.Cleanup(func() {
		for _, table := range []string{
			...
			"user_oauth_bindings", "users", "logs", "channels", "quota_data",
			"abilities", "top_ups", "subscription_orders", "subscription_plans",
			"user_subscriptions", "perf_metrics", "system_instances",
