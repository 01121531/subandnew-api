...
var expectedControlPlaneTables = []string{
	...
	"mailbox_attachments",
	"mailbox_audits",
	"mailbox_card_index_states",
	"mailbox_card_indices",
	"mailbox_cvvs",
	"mailbox_issues",
	...
	"managed_account_api_instances",
	"managed_account_api_keys",
	"managed_account_api_portal_sessions",
	"managed_account_apis",
	"managed_account_daily_snapshots",
	"managed_account_export_deliveries",
	"managed_account_export_runs",
	"managed_account_export_schedules",
	...
	"managed_instance_alert_assignments",
	"managed_instance_alert_rule_instances",
	"managed_instance_alert_rules",
