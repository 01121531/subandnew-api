export const mailboxPortalEn = {
  ...
  filteredTotal: 'Filtered accounts: {{count}}',
  retryCooldown: 'Retry in {{count}}s',
  refreshFailed: 'Refresh failed. Showing the last loaded list.',
...
export const mailboxPortalZh: Record<keyof typeof mailboxPortalEn, string> = {
  ...
  filteredTotal: '筛选结果：{{count}} 个',
  retryCooldown: '{{count}} 秒后可重试',
  refreshFailed: '刷新失败，当前显示上次加载的列表。',
  remark: '提交备注',
