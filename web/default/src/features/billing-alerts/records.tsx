...
function eventRowClass(type: string) {
  if (type === 'monitor_failure') return 'border-l-2 border-l-red-500'
  if (type === 'monitor_recovery') return 'border-l-2 border-l-emerald-500'
    ...
    <SectionPageLayout>
      ...
      <SectionPageLayout.Content>
        <div className='min-w-0'>
          <div className='mb-4 grid gap-3 rounded-lg border p-4 sm:grid-cols-[220px_minmax(240px,1fr)_auto]'>
            <NativeSelect
              value={eventType}
              onChange={(e) => {
          ...
          >
            <DialogContent className='sm:max-w-2xl'>
              <DialogHeader>
                ...
                <DialogDescription>
                  {selected &&
                    `${selected.instance_name} · ${selected.rule_name}`}
                </DialogDescription>
              </DialogHeader>
              {selected && (
