      ...
      <div className='grid gap-2 md:hidden'>
        {props.instances.map((instance) => (
          <div
            ...
            role='link'
            tabIndex={0}
            className='hover:bg-muted/50 focus-visible:ring-ring grid min-w-0 cursor-pointer gap-3 rounded-lg border p-3 transition-colors focus-visible:ring-2 focus-visible:outline-none'
