...
func TestSupplierRoutesAndAnonymousLimit(t *testing.T) {
	...
	for _, route := range []string{"GET /api/suppliers", "POST /api/suppliers/:id/password", "GET /api/suppliers/:id/audits", "GET /supplier-api/v1/auth/session", "POST /supplier-api/v1/account-upload/exchange", "PATCH /supplier-api/v1/proxies/:id"} {
