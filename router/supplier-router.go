...
func registerSupplierRoutes(engine *gin.Engine, api *gin.RouterGroup) {
	...
	admin.Use(controller.SupplierAuditTrail(), middleware.AdminAuth(), middleware.AnonymousRequestBodyLimit(), controller.SupplierAdminAccess)
	...
	admin.GET("/default-policy", controller.SupplierRootOnly, view, controller.GetSupplierDefaultPolicy)
	admin.PUT("/default-policy", controller.SupplierRootOnly, manage, controller.SaveSupplierDefaultPolicy)
	admin.GET("/portal-settings", controller.SupplierRootOnly, view, controller.GetSupplierPortalSettings)
	admin.PUT("/portal-settings", controller.SupplierRootOnly, manage, controller.SaveSupplierPortalSettings)
	admin.POST("/:id/takeover", controller.SupplierRootOnly, controller.TakeoverSupplier)
