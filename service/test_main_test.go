...
func TestMain(m *testing.M) {
	...
	if err := db.AutoMigrate(
		...
		&model.ManagedAccountDailySnapshot{},
...
func truncate(t *testing.T) {
	...
	t.Cleanup(func() {
		for _, table := range []string{
			...
			"managed_instance_audits", "managed_instance_snapshots", "managed_dashboard_snapshots", "managed_account_daily_snapshots", "managed_account_snapshots", "managed_rpm_history",
